document.addEventListener('DOMContentLoaded', ()=> {
  ...
  for (let i = 0, len = squares.length; i < len; i++) {
      ...
      squares[i].onclick = function () {
        ...
        } else console.log("can't go here")
      }
  }
    ...
    function checkBoard() {
      ...
      for (let y = 0; y < winningArrays.length; y++) {
        ...
        //now check these arays to see if they all have the class of player-one
  ...
  //add an eventLister to each square that will trigger the checkBoard function on click
